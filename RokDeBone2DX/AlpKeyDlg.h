// AlpKeyDlg.h : CAlpKeyDlg の宣言

#ifndef __AlpKeyDlg_H_
#define __AlpKeyDlg_H_
...
// CAlpKeyDlg
class CAlpKeyDlg : 
	public CAxDialogImpl<CAlpKeyDlg>
{
public:
	enum { IDD = IDD_ALPKEYDLG };


	CAlpKeyDlg( CMotParamDlg* srcmpdlg );
	~CAlpKeyDlg();
...
private:
	...
	int InitList();
	int AddItem2List( int itemno, CMQOMaterial* srcmat, float srcalpha, int existflag );
